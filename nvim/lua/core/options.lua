vim.wo.number = true -- default false
...
if my_target_path then
	...
	vim.g.vimwiki_list = {
		{
			-- set the path to my google drive
			path = my_target_path,
			-- set the document type to markdown
			syntax = "markdown",
			-- set the file extension to md
			ext = ".md",
		},
	}
	vim.g.vimwiki_global_ext = 0 -- restrict vimwiki to the paths listed
else
